    ...
    methods: {
        ...
        updateArray: function () {
            return __awaiter(this, void 0, void 0, function () {
                var name, surname, birth_date, salary, role, reporting_line_manager, split, _a, data_1, error_1, _b, data, error;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            name = document.getElementById('Addname').value;
                            surname = document.getElementById('Addsurname').value;
                            birth_date = document.getElementById('Addbirth_date').value;
                            salary = document.getElementById('Addsalary').value;
                            role = document.getElementById('Addrole').value;
                            reporting_line_manager = document.getElementById('Addreporting_line_manager').value;
                            //  check if all the fields are filled
                            if (name === '' || surname === '' || birth_date === '' || salary === '' || role === '') {
                                alert('Cannot leave any field besides Reporting Line Manager empty');
                                return [2 /*return*/];
                            }
                            if (!(reporting_line_manager === '')) return [3 /*break*/, 1];
                        ...
                        case 2:
                            ...
                            reporting_line_manager = data_1[0].employee_number;
                            _c.label = 3;
...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({ type: ("text"), id: ("Addname"), name: ("name"), placeholder: ("Enter Name"), required: (true), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({ for: ("surname"), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({ type: ("text"), id: ("Addsurname"), name: ("surname"), placeholder: ("Enter Surame"), required: (true), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({ for: ("birth_date"), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({ type: ("date"), id: ("Addbirth_date"), name: ("birth_date"), required: (true), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({ for: ("salary"), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({ type: ("number"), id: ("Addsalary"), name: ("salary"), placeholder: ("Enter Salary"), required: (true), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({ for: ("role"), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({ type: ("text"), id: ("Addrole"), name: ("role"), placeholder: ("Enter Role"), required: (true), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({ for: ("reporting_line_manager"), });
    __VLS_elementAsFunction(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({ type: ("text"), id: ("Addreporting_line_manager"), name: ("reporting_line_manager"), placeholder: ("Reporting Line Manager Name and Surname"), required: (true), });
