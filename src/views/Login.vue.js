    ...
    methods: {
        submit: function () {
            return __awaiter(this, void 0, void 0, function () {
                var everythingOk, userEmail, userPassword, _a, data, error;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!everythingOk) return [3 /*break*/, 2];
                            return [4 /*yield*/, supabase.auth.signInWithPassword({ email: userEmail, password: userPassword })];
                        case 1:
